...
const char* mqttServer = "192.168.0.225";
const char* HostName = "Vector NODE RED";
const char* mqttUser = "";
...
/*
  ...
  client.setCallback(callback);   */
    ...
    // ------------------------------------------------
    // 1. Configure PIR as wake-up source
    // ------------------------------------------------
    ...
    if (wakeup_reason == ESP_SLEEP_WAKEUP_EXT0) {
        ...
        Serial.println("ESP32 woke from deep sleep");
    ...
    // ------------------------------------------------
    // 11. Prepare PIR for next wake-up
    // ------------------------------------------------
